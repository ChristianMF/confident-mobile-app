      ...
      return (
          ...
          <ScrollView contentContainerStyle={{flexGrow: 1, justifyContent: 'center', alignItems: 'center'}}>
            <SafeAreaView style={{width: '95%'}}>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Recopilación de respuestas, opciones elegidas y palabras vertidas al chat para generar reportes estadísticos y propuestas a políticas publicas</Text>
              ...
              <Text style={styles.textOptionButton}>Recopilación de respuestas, opciones elegidas y palabras vertidas al chat para generar reportes estadísticos y propuestas a políticas publicas</Text>
              </TouchableOpacity>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Análisis de lenguaje para poder seguir actualizando el chatbot</Text>
              <Text style={styles.indentText}>{'\u2B50'}Análisis de sentimientos para la realización de estudios e investigaciones científicas</Text>
              <Text style={styles.indentText}>{'\u2B50'}Para recopilación de respuestas, opciones elegidas y palabras vertidas al chat para generar reportes estadísticos y propuestas a políticas publicas</Text>
