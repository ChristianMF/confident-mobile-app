...
import { KeyboardAvoidingView, View, Text, StyleSheet, TouchableOpacity, ImageBackground, Image, Button, SafeAreaView, ScrollView} from 'react-native';
...
class PrivacyPolicy extends Component {
    ...
    onSend3() {
      ...
      let messages = [
        {
          _id: sessionId,
          text: 'Recopilación de los temas y las preguntas mas realizadas para generar propuestas a políticas publicas',
          createdAt: new Date(),
          user: user
        }
      ];
    ...
    onSend4() {
      ...
      let messages = [
        {
          _id: sessionId,
          text: 'Ubicación para poder análisis de temas que más se trataron por zonas',
          createdAt: new Date(),
          user: user
        }
      ];
      ...
      return (
          ...
          <ScrollView contentContainerStyle={{flexGrow: 1, justifyContent: 'center', alignItems: 'center'}}>
            <SafeAreaView style={{width: '95%'}}>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Recopilación de los temas y las preguntas mas realizadas para generar propuestas a políticas publicas</Text>
              <Text style={styles.indentText}>{'\u2B50'}Ubicación para poder análisis de temas que más se trataron por zonas</Text>
              <Text style={styles.normalText}>En caso de que no desee que sus datos personales se utilicen para estos fines secundarios, indíquelo a continuación:</Text>
              ...
              <Text style={styles.textOptionButton}>Recopilación de los temas y las preguntas mas realizadas para generar propuestas a políticas publicas</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.optionButton} onPress={()=> [alert('Se ha enviado tu solicitud. Cualquier duda contactar directamente con: botconfident@gmail.com ¡Gracias!'), this.onSend4()]}>
              <Text style={styles.textOptionButton}>Ubicación para poder análisis de temas que más se trataron por zonas</Text>
              </TouchableOpacity>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Sexo</Text>
              <Text style={styles.indentText}>{'\u2B50'}Ubicación de su dispositivo móvil</Text>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Por medio de la pagina web</Text>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Contacto en la pagina web</Text>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Análisis de lenguaje para poder seguir actualizando el chatbot</Text>
              <Text style={styles.indentText}>{'\u2B50'}Análisis de sentimientos para la realización de estudios e investigaciones científicas</Text>
              <Text style={styles.indentText}>{'\u2B50'}Para conocer que tipo de información necesita el usuario por regiones y así poder proponer campañas informativas</Text>
              <Text style={styles.indentText}>{'\u2B50'}Para generar propuestas a políticas publicas</Text>
              <Text style={styles.indentText}>{'\u2B50'}Recopilación de los temas y las preguntas mas realizadas</Text>
              <Text style={styles.normalText}>Los datos personales que obtenemos de estas tecnologías de rastreo son los siguientes:</Text>
              <Text style={styles.indentText}>{'\u2B50'}Región en la que se encuentra el usuario</Text>
              ...
              <Text style={styles.normalText}>Nos comprometemos a mantenerlo informado sobre los cambios que pueda sufrir el presente aviso de privacidad, a través de: Por medio de la pagina web.</Text>
              ...
              <Text style={styles.indentText}>{'\u2B50'}Se publicarán las modificaciones en el apartado de aviso de privacidad de la pagina</Text>
              <Text style={styles.dateNormalText}>Última actualización: 08/07/2020</Text>
