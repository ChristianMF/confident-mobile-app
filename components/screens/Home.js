...
class Home extends Component {
  ...
  state = {
    ...
    messages: [
      ...
      {
        _id: 2,
        text: 'Hola, te invito a que antes de comenzar la conversación leas de qué se trata la app dando clic en el icono de 🏠. Tenemos contactos de ayuda que te pueden servir en el icono de 📞. Siempre que quieras regresar a esta pantalla, da clic sobre el logo "Confident ✌️"',
        createdAt: new Date(),
        user: BOT_USER
      },
    ]
  ...
  componentDidMount() {
    ...
    LogBox.ignoreLogs(['Animated: `useNativeDriver`', 'Animated.event', 'Setting a timer for']);
